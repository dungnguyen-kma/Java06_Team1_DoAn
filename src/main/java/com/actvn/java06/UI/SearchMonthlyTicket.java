...
public class SearchMonthlyTicket extends javax.swing.JFrame {
    ...
    private void txtNameKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNameKeyReleased
        ...
        if (key.equals("")) {
            ...
            for (MonthlyTicket ticket : monthlyTickets) {
                if (key.equalsIgnoreCase(ticket.getCustomerName())) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchMonthlyTicket.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
